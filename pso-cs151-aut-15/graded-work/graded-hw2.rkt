...
(define (value-or-pass a b c)
  (cond
    ...
    ;;GRADER: this isn't necessarily true. you just need b+c < 10
...
;;GRADER: I think you misunderstood the formula. It should be ax^2+bx+c
