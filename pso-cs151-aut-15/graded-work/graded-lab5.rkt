...
;; World captures needed state      4  /  4
;; displacement calculation         5  /  5
;; velocity calculation             4  /  5 When e = 1, the balls won't stop. Bug in velocity calculation.
;; bounce detection                 5  /  5
;; installation of handlers in b-b  2  /  3 Write a more generic function (run-sim) to handle different balls
;; tick handling                    2  /  4 Every tick is 1/28 second not 1 second.
;; finished? detection              5  /  5
;; individual ball images           1  /  4  You need to take into account the scaling factor : pixels per meter. Your calculation is based on the scale of meters, but your image is based on pixel scale
;; composition of images            5  /  5
